...
type Step = {
  ...
  const allSteps: Step[] = [
    { id: "1", title: "Complete Getting Started", completed: false, type: "quick" },
    { id: "2", title: "Create your second waiver", completed: false, type: "quick" },
    { id: "3", title: "Leave feedback or request a feature", completed: false, type: "quick" },
    { id: "4", title: "Share via QR code", completed: false, type: "quick" },
    { id: "5", title: "Customize waiver design", completed: false, type: "quick" },
    { id: "6", title: "Export waivers as CSV", completed: false, type: "quick" },
    { id: "7", title: "Save a waiver template", completed: false, type: "quick" },
    { id: "8", title: "Download your first waiver", completed: false, type: "quick" },
    { id: "9", title: "Create 10 waivers", completed: false, type: "stretch", current: 2, goal: 10 },
    { id: "10", title: "Create 25 waivers", completed: false, type: "stretch", current: 2, goal: 25 },
    { id: "11", title: "Create 50 waivers", completed: false, type: "stretch", current: 2, goal: 50 },
    { id: "12", title: "Create 100 waivers", completed: false, type: "stretch", current: 2, goal: 100 },
  ];
